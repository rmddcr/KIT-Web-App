      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 content wow fadeInRight">
            ...
            <ul>
              <li><i class="ion-android-checkmark-circle"></i> Lack of vehicle diagnosis knowledge.</li>
              <li><i class="ion-android-checkmark-circle"></i> Recognize faults only when critical.</li>
              <li><i class="ion-android-checkmark-circle"></i> No way to schedule maintenance</li>
              <li><i class="ion-android-checkmark-circle"></i> Walking around miles for find a garage</li>
              <li><i class="ion-android-checkmark-circle"></i> Not knowing which garage to trust</li>
            </ul>

            <p>
              To overcome these problems, we came up with an app to cater the needs of the driver, KIT where we can track the condition of your vehicle, diagnose issues and then guide you to the nearest garage.
            </p>
          </div>
        </div>
          ...
          <div class="col-lg-8 col-md-7 ">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 box wow fadeInRight">
                ...
                <h4 class="title"><a href="">Real Time Vehicle Data</a></h4>
                <p class="description">Vehicle’s real-time data from ECU* gathered to mobile device via blue tooth connectivity using OBD* technology.</p>
              </div>
              <div class="col-lg-6 col-md-6 box wow fadeInRight" data-wow-delay="0.1s">
                <div class="icon"><i class="ion-ios-flask-outline"></i></div>
                <h4 class="title"><a href="">Warning & Critical Alerts</a></h4>
                <p class="description">Get connected with the OBD technology & Identify the Engine problems, Overheating problems, Fuel and air metering etc.</p>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              ...
              <div class="wow fadeInLeft">
                <h2>Warning Critical Alerts & Scheduler</h2>
                <p>Another problem drivers come across is they cannot easily keep track of when to change oil, how’s the condition of your engine, Schedule periodical services, Keep track of oil, water and other lubricant changes/refills &
keeping track of license, insurance due dates and lease installments.
</p>
    ...
    <section id="more-features" class="section-bg">
      <div class="container">
        ...
        <div class="section-header">
          ...
          <span class="section-divider"></span>
          <p class="section-description">Here are more features where KIT make it user freindly</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight">
              ...
              <h4 class="title"><a href="">Landscape Mode </a></h4>
              <p class="description">Landscape mode implementation give the sense of dashboard for drivers.</p>
            </div>
          </div>
